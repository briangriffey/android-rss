...
//    assertEquals(Uri.parse("http://example.com/"), feed.getUriLink());
...
//    assertEquals(Uri.parse("http://example.com/2010/11/07"), item.getUriLink());
...
//
//    MediaThumbnail expectedThumbnail0 = new MediaThumbnail("http://example.com/media/images/12/jpg/_7_2.jpg", 49, 66);
...
//
//    MediaThumbnail expectedThumbnail1 = new MediaThumbnail("http://example.com/media/images/12/jpg/_7_2-1.jpg", 81, 144);
